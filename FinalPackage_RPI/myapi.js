...
for (i in inputs) {
  ...
  //console.log(inputs[i].pin + inputs[i].gpio)
...
setInterval( function () {
  ...
  gpio.read(inputs[0].pin, function (err, value) {
    ...
    console.log(inputs[0].pin + value);
  ...
  gpio.read(inputs[1].pin, function (err, value) {
    ...
    console.log(inputs[1].pin + value);
  ...
  gpio.read(inputs[2].pin, function (err, value) {
    ...
    console.log(inputs[2].pin + value);
    // update the inputs object
  ...
  gpio.read(inputs[3].pin, function (err, value) {
    ...
    console.log(inputs[3].pin + value);
  ...
  gpio.read(inputs[4].pin, function (err, value) {
    ...
    console.log(inputs[4].pin + value)
    // update the inputs object
  ...
  gpio.read(inputs[5].pin, function (err, value) {
    ...
    console.log(inputs[5].pin + value)
...
app.get('/state', function (req, res) {
  ...
  // ////////////////
  // if ((sp4t_list[0].val == '1') && (sp4t_list[1].val == '1')){
  //   res.status(200).send(sp4t_map.get(sp4t_list[0].val));
  //   //$('#input_' + data.gpio).html('State of Antenna: ' + sp4t_map.get(sp4t_list[0].val));
  //   //console.log(sp4t_map.get(sp4t_list[0].val));
  //   if ((rala_list[0] == '1') && (rala_list[3] == '1')){
  //     res.status(200).send('State of Antenna: State 0 Omni');
  ...
  //       var value = rala_states[key];
  //       if(key == '1'){
  //         res.status(200).send('State of Antenna: ' + value);
  //         //$('#input_' + data.gpio).html('State of Antenna: ' + value);
  //         //console.log(value);
  //       } else {
  //         res.status(200).send("No direction specified");
  ...
  //       // console.log(value);
  //     } else {
  //       res.status(200).send('State of Antenna: RF 4 - RF Matrix');
